...
lc_trend, flares, sigma = trend_lightcurve(time_raw, pdcflux_raw, windowsize, windowstep)
#flares = flare_corrections(time_raw, pdcflux_raw, lc_trend, flares, int(0.05*windowsize), sigma)
